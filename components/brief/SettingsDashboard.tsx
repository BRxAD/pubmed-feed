      ...
      <section>
        ...
        <div className="mt-6">
          <ToggleRow
            ...
            hint="On (default): newest publish or ingest first (prefer published, else latest ingest); highest priority wins ties. Off: highest priority first, then that same recency."
