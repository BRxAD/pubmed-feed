-- Main AMS PubMed topic: stewardship/use core AND high-signal study types,
-- without locking to specific ASP tactics (pre-auth, etc.).
-- Keeps animal exclusion as (animals NOT humans). Drops bare treatment ORs
-- that flood low-priority ID papers; keeps use/exposure for sensitivity.
