...
const SYNONYM_EXPANSIONS: Array<{ match: RegExp; add: string }> = [
  ...
  { match: /\bvancomycin\b/i, add: "vancomycin intravenous gram-positive therapeutic drug monitoring" },
  { match: /\baminoglycoside\b|\bgentamicin\b|\btobramycin\b|\bamikacin\b/i, add: "aminoglycoside gentamicin therapeutic drug monitoring intravenous" },
  { match: /\btimeout\b|antibiotic timeout/i, add: "antibiotic timeout duration stewardship" },
  { match: /\bpatient education\b|\bcounseling\b|shared decision/i, add: "patient education counseling outpatient clinic" },
  { match: /\bsusceptibility testing\b|\bantimicrobial susceptibility\b|\bast\b/i, add: "antimicrobial susceptibility antibiogram microbiology culture" },
