...
- **Brief digest email** — headline links to **PubMed**; article date sits tightly **above** the headline. Under each story: **Read article** plus Email / LinkedIn. Do **not** add a “via stewardshipbrief.com” line in the email (that credit is for copied / outbound shares only). Copy, native Share, Graphic takeaway, X, and Facebook do not appear in email. “Open today’s brief” / footer still point at the site.
...
- Digest email: headline → PubMed; date above headline; Read article + Email/LinkedIn share links (no X or Facebook). No via-line in email. Email cannot Copy, native-share, or Graphic takeaway.
